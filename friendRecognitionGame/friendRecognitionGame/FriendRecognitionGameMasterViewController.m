//
//  FriendRecognitionGameMasterViewController.m
...
@interface FriendRecognitionGameMasterViewController () {
    NSMutableArray *_objects;
}
@end

@implementation FriendRecognitionGameMasterViewController
